...
```
654 @params any obj{x:str,y:str} @ret str  # concat
```
...
```
976 @params any obj{first:obj{x:str,y:str},second:str} @ret str  # concat_nested
```
...
#44:LoadField[BuildLoadDataField, tagged base, 12, ADDR8: [String] in ReadOnlySpace: #first, ADDR9 <Map[20](HOLEY_ELEMENTS)>, OtherObject, kRepTaggedPointer|kTypeAny, FullWriteBarrier, const (field owner: ADDR10 <Map[52](HOLEY_ELEMENTS)>)](#2:Parameter, #43:CheckMaps, #78:Merge)
...
#44:LoadField[BuildLoadDataField, tagged base, 12, ADDR8: [String] in ReadOnlySpace: #first, ADDR9 <Map[20](HOLEY_ELEMENTS)>, OtherObject, kRepTaggedPointer|kTypeAny, FullWriteBarrier, const (field owner: ADDR10 <Map[52](HOLEY_ELEMENTS)>)](#2:Parameter, #43:CheckMaps, #75:Merge)
